...
- Recovery Time - Mesured in second during which the service is not available, after a failure and until the backup server takes over.
...
[Figure 6 - Loadbalancing service failure ](https://github.com/reTHINK-project/testbeds/blob/master/docs/Trials-evaluation/D6.4-Domain_registry/keepalived_ha.pdf)
...
[Figure 7](https://github.com/reTHINK-project/testbeds/blob/master/docs/Trials-evaluation/D6.4-Domain_registry/keepalived_keep.pdf)
